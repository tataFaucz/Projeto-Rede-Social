...
public class CadastroPanel extends JPanel {
    ...
    public CadastroPanel(Sistema sistema, MainFrame mainFrame) {
        ...
        gbc.gridx = 0; gbc.gridy = 4; add(btnCadastrar, gbc);
        gbc.gridx = 1; gbc.gridy = 4; add(btnVoltar, gbc);
        ...
        btnCadastrar.addActionListener(e -> {
            ...
            boolean sucesso = sistema.cadastrarUsuario(nome, email, senha, fotoPerfil);
            if (sucesso) {
